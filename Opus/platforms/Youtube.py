...
async def download_song(link: str, download_mode: str = "audio"):
    ...
    # Try API 2 first
    try:
        song_url2 = f"{API_URL2}?url=https://youtube.com/watch?v={video_id}&format=mp3&audioBitrate=320"
        async with aiohttp.ClientSession() as session:
...
class YouTubeAPI:
    def __init__(self):
        ...
        self.regex = r"(?:youtube\.com|youtu\.be|music\.youtube\.com)" # added Yt music support 
    ...
    async def download(
        ...
        if songvideo or songaudio:
            ...
            # Fallback to yt-dlp if APIs fail
            if songvideo:
